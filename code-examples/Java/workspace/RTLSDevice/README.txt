...
- Install the Android Development Tools plugin for Eclipse, or (Windows users) use the pre-configured Eclipse environment on this USB device.
- Install the Android SDK version 4.1, or use the Android SDK included in the RTLSDevice project (the android-sdk folder).
